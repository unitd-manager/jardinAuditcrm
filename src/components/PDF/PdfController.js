...
const PdfController = ({ControllerId}) => {
  PdfController.propTypes = {
    ControllerId: PropTypes.any
  }
  ...
  const getCompanyAddressData = () => {
    api
      .post('/clients/getControllerPdf', { contact_id: ControllerId })
      .then((res) => {
          ...
          '\n',
{
  ...
  return (
    <>
  <span onClick={GetPdf}><u>Reg Of Contract</u></span>
   </>
  );
};
