...
const PdfProjectPaidUpCapital = () => {
  const { id } = useParams();

  const [companyaddressDetails, setCompanyAddressDetails] = useState();
  const [directorNameDetails, setDirectorNameDetails] = useState([0]);
  ...
  const GetPdf = () => {
    ...
    const dd = {
      content: [
        ...
        {
          text: `Date:               ${
            companyaddressDetails.date_of_incorporation
              ? companyaddressDetails.date_of_incorporation
              : ''
          } `,
          style: 'textSize',
        ...
        '\n',
        {
          columns: [
            ...
            },
            {
              stack: [
                {
                  text: ` ${companyaddressDetails.reg_no ? companyaddressDetails.reg_no : ''}\n`,
                  style: 'textSize',
                  bold: false,
                  color: 'blue',
                  margin: [-190, 0, 0, 0],
...
export default PdfProjectPaidUpCapital;
