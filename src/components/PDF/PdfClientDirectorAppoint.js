...
const PdfClientDirectorAppoint = ({directorResignId,companyId}) => {
  PdfClientDirectorAppoint.propTypes = {
  ...
  return (
    <>
     <span onClick={GetPdf}><u>Dir.Appoint</u></span>
    </>
  );
};

export default PdfClientDirectorAppoint;
