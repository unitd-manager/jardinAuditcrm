...
const PdfClientDirectorResign = ({directorResignId,companyId}) => {
  PdfClientDirectorResign.propTypes = {
  ...
  const GetPdf = () => {
    ...
    const dd = {
      ...
      content: [
        ...
        '\n',
        {
          text: `DIRECTOR'S RESOLUTION DATED ${(companycontactDetails.appoint_date)? moment(companycontactDetails.appoint_date).format('DD-MM-YYYY'):''}    PASSED PURSUANT\n `,
          style: 'textSize',
          bold: true,
          alignment: 'center',
          fontSize: 10.5,
        ...
        {
          text: `Resolved that the Resignation of  ${
            ...
            companycontactDetails.id_card_no
              ? companycontactDetails.id_card_no
              : ''
          } as a Director of the Company is hereby accepted with immediate effect.\n\n`,
          style: 'textSize',
          fontSize: 11,
        },
        ...
        '\n',
        {
          text: `PASSED THIS ON : ${(companycontactDetails.appoint_date)? moment(companycontactDetails.appoint_date).format('DD-MM-YYYY'):''} \n\n`,
          style: 'textSize',
          fontSize: 10.5,
          bold: true,
        },
  ...
  return (
    <>
     <span onClick={GetPdf}><u>Dir.Resign</u></span>
    </>
  );
};

export default PdfClientDirectorResign;
